  ...
  <Fragment>
    <Header>
      <Icon idth="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M6 5C4.89543 5 4 5.89543 4 7V15C4 16.1046 4.89543 17 6 17H11L13.5774 19.7492C14.1012 20.3079 15.033 20.0946 15.2614 19.3635L16 17H18C19.1046 17 20 16.1046 20 15V7C20 5.89543 19.1046 5 18 5H6Z"/>
        </mask>
